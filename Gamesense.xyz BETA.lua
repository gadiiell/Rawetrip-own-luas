...
acid_ui.Info.AboutLua.Creator = ui.add_label("Creator: 乃ㄖ丂丂#8857")
acid_ui.Info.AboutLua.Discord = ui.add_label("Discord Server Link: https://discord.gg/8DqKDa8vMv")
...
acid_ui.Info.AboutUser.Discord = ui.add_label("Discord Server Link: https://discord.gg/8DqKDa8vMv")
-- End
